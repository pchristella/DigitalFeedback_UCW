<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="UCW_nonstaff_quizconfirm.aspx.cs" Inherits="DigitalFeedback_UCW.Module.NonStaff.UCW_nonstaff_quizconfirm" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table runat="server">
        ...
        <asp:TableRow>
            <asp:TableCell CssClass="lbl_5"><asp:Label runat="server" Text="Label" ID="lbl_1"></asp:Label></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
