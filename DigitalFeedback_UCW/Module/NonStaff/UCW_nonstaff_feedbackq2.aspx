<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="UCW_nonstaff_feedbackq2.aspx.cs" Inherits="DigitalFeedback_UCW.Module.NonStaff.UCW_nonstaff_feedbackq2" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table runat="server" Width="100%">
        ...
        <asp:TableRow>
            <asp:TableCell ColumnSpan="10" CssClass="lbl_3">Bagaimanakah penilaian anda terhadap <font color="red">keseluruhan acara</font>?</asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
        ...
        <asp:TableRow>
            <asp:TableCell ColumnSpan="10"><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/back.png" OnClick="ImageButton1_Click" ImageAlign="Right" /></asp:TableCell>
        </asp:TableRow>
    </asp:Table>
    </div>
</asp:Content>
