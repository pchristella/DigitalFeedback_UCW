<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="UCW_nonstaff_feedback.aspx.cs" Inherits="DigitalFeedback_UCW.Module.NonStaff.UCW_nonstaff_feedback" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table runat="server" Width="100%">
        ...
        <asp:TableRow>
            <asp:TableCell ColumnSpan="3" CssClass="lbl_3"><font color ="red">Tempoh</font> acara di anjurkan adalah :</asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
