<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="UCW_nonstaff_feedbackq4.aspx.cs" Inherits="DigitalFeedback_UCW.Module.NonStaff.UCW_nonstaff_feedbackq4" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table runat="server" Width="100%">
        <asp:TableRow>
            <asp:TableCell ColumnSpan="10" CssClass="lbl_2">4. How do you rate the <font color="red">venue and facilities</font> for the event?</asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell ColumnSpan="10" CssClass="lbl_3">Bagaimanakah penilaian anda terhadap <font color="red">tempat dan kemudahan</font> bagi acara ini?</asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
