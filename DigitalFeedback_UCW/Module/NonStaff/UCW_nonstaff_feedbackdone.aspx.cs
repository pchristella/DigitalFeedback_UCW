...
{
    public partial class UCW_nonstaff_feedbackdone : System.Web.UI.Page
    {
        ...
        public bool qs_pass()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT quiz_nonstaff_score FROM quiz_nonstaff WHERE quiz_nonstaff_icno = '" + icno + "' ORDER BY quiz_nonstaff_score DESC LIMIT 1";
                cmd.Connection = conn;
        ...
        public string qs_score()
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    if (dr.HasRows == true)
                    {
                        score = dr["quiz_nonstaff_score"].ToString();
                    }
                }
        ...
        public bool chkout_stat()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT checkout_dt FROM nonstaff WHERE ic_passport = '" + icno + "'";
                cmd.Connection = conn;
