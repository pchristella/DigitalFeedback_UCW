<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="UCW_nonstaff_quiz5.aspx.cs" Inherits="DigitalFeedback_UCW.Module.NonStaff.UCW_nonstaff_quiz5" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table runat="server" Width="100%">
         ...
         <asp:TableRow><asp:TableCell ColumnSpan="2"><asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/img/next.png" OnClick="ImageButton5_Click" ImageAlign="Right" />&nbsp;<asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="~/img/prev.png" OnClick="ImageButton6_Click" ImageAlign="Right" />&nbsp;</asp:TableCell></asp:TableRow>
        </asp:Table>
    </div>
</asp:Content>
