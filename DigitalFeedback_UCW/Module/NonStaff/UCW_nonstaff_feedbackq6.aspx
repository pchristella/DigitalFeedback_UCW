<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="UCW_nonstaff_feedbackq6.aspx.cs" Inherits="DigitalFeedback_UCW.Module.NonStaff.UCW_nonstaff_feedbackq6" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
     ...
     <asp:Table runat="server" Width="100%">
        ...
        <asp:TableRow>
            <asp:TableCell CssClass="lbl_3"><font color="red">Cadangan-cadangan</font> untuk penambahbaikkan (jika ada)</asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell>
                <br />
