<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="UCW_staff_quiz4.aspx.cs" Inherits="DigitalFeedback_UCW.Module.Staff.UCW_staff_quiz4" %>
...
<%--    4. <asp:Label ID="Label1" CssClass="lbl_2" runat="server" Text="Label"></asp:Label>
        <br />
        <br />
