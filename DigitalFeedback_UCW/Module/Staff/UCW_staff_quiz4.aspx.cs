...
{
    public partial class UCW_staff_quiz4 : System.Web.UI.Page
    {
        public string idno = "";
        public string set = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT quiz_staff_temp_q4 FROM quiz_staff_temp WHERE quiz_staff_temp_idno = " + idno + "";
                cmd.Connection = conn;
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                cmd2.CommandText = "UPDATE quiz_staff_temp SET quiz_staff_temp_q4=1 WHERE quiz_staff_temp_idno = '" + idno + "'";
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                MySqlCommand cmd2 = new MySqlCommand();
                cmd2.CommandType = CommandType.Text;
                cmd2.CommandText = "UPDATE quiz_staff_temp SET quiz_staff_temp_q4=2 WHERE quiz_staff_temp_idno = '" + idno + "'";
                cmd2.Connection = conn;
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                MySqlCommand cmd2 = new MySqlCommand();
                cmd2.CommandType = CommandType.Text;
                cmd2.CommandText = "UPDATE quiz_staff_temp SET quiz_staff_temp_q4=3 WHERE quiz_staff_temp_idno = '" + idno + "'";
                cmd2.Connection = conn;
        ...
        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                MySqlCommand cmd2 = new MySqlCommand();
                cmd2.CommandType = CommandType.Text;
                cmd2.CommandText = "UPDATE quiz_staff_temp SET quiz_staff_temp_q4=4 WHERE quiz_staff_temp_idno = '" + idno + "'";
                cmd2.Connection = conn;
