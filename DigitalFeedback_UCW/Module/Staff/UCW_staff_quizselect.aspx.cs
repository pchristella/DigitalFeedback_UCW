...
namespace DigitalFeedback_UCW.Module.Staff
{
    ...
    public partial class UCW_staff_quizselect : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("UCW_staff_quiz1.aspx?id=" + idno + "&set=1");
        }

        protected void Imgbtn2_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("UCW_staff_quiz1.aspx?id=" + idno + "&set=2");
        }

        protected void Imgbtn3_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("UCW_staff_quiz1.aspx?id=" + idno + "&set=3");
        }

        protected void Imgbtn4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("UCW_staff_quiz1.aspx?id=" + idno + "&set=4");
        }

        protected void Imgbtn5_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("UCW_staff_quiz1.aspx?id=" + idno + "&set=5");
        }
