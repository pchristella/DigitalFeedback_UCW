...
{
    public partial class UCW_luckydraw_result_staff : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                while (dr.Read())
                {
                    if (dr.HasRows == true)
                    {
                        Label1.Text = dr["staffid"].ToString();
            ...
            try
            {
                ...
                cmd2.CommandText = "UPDATE staff SET luckydraw_st=1 WHERE staffid = '" + Label1.Text + "'";
